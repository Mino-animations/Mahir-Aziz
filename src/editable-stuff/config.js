...
const mainBody = {
  ...
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/hashirshoae",
    },
    {
      image: "fa-instagram",
...
const repos = {
  ...
  gitHubUsername: "Mino-animations", //i.e."johnDoe12Gh"
  reposLength: 4,
  specificRepos: [],
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("src/editable-stuff/mino.jpg"), 
...
const getInTouch = {
  ...
  message:
    "I'm currently looking for animation internship opportunities! If you know of any positions available, if you have any questions, or if you just want to say hi, please feel free to email me at",
  email: "mahiraziz2@gmail.com",
};
